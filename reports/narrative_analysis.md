...
UNISON Facility Services is a subsidiary of **Metlen Energy & Metals** (formerly Mytilineos Group — one of the largest industrial conglomerates in Greece, listed on ASE). The company holds **14 international certifications** and operates at national scale. Its public client list includes **ΓΝ Λαμίας, ΓΝ Βόλου, and Metropolitan General Hospital** — confirming it is an established Greek hospital cleaning services provider, not a local or ad-hoc contractor. This corporate context is relevant for assessing why the 2023 tender attracted no valid competing bids: UNISON is one of the few national FM companies with documented multi-hospital track record and the certification profile a hospital tender specification would typically require. The pool of qualifying competitors in the Greek hospital FM market is structurally small.

**What requires further investigation:**

- **UNISON incumbency and tender specifications:** Why did two international publications of a €4.386M tender attract no valid bids in 2023? The full tender documents (ΕΣΗΔΗΣ 175970 and 195241) — which contain the actual qualification criteria, minimum turnover requirements, workforce requirements, and technical standards — are on the ΕΣΗΔΗΣ portal (`portal.eprocurement.gov.gr`) which requires JavaScript rendering and F5 bot-protection cookies; they are not accessible via automated fetching or web search. Three plausible explanations for the tender failure exist: (a) qualification criteria (certifications, hospital experience, minimum turnover) were set at a level that only UNISON could meet; (b) the labour cost benchmark in the specifications was set below 2023 post-inflation market rates, making a below-estimate bid economically unviable for any competitor; (c) the hospital FM market has a structurally small number of qualifying competitors at this contract scale. Explanation (b) is consistent with the pattern seen in many Greek public hospital cleaning tenders in 2022–2024, when rising minimum wage and CBA adjustments made previously-tendered rates noncompetitive. Explanation (a) would require reading the specifications directly. **This investigation requires manual inspection of the ΕΣΗΔΗΣ portal or direct contact with the hospital procurement office (promithies@hosplam.gr).**
